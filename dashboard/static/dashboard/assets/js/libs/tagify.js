        ...
        (function (t, e) {
            ...
            var l = () => /(?=.*chrome)(?=.*android)/i.test(navigator.userAgent),
                d = {
                    ...
                    show(e) {
                        ...
                        if (((e = void 0 === e ? this.state.inputText : e), (!d || l || o.templates.dropdownItemNoMatch) && !1 !== o.dropdown.enable && !this.state.isLoading)) {
                            if (
                                ...
                                e && !this.suggestedListItems.length && (this.trigger("dropdown:noMatch", e), o.templates.dropdownItemNoMatch && (a = o.templates.dropdownItemNoMatch.call(this, { value: e }))),
                                !a)
                            ) {
                                if (this.suggestedListItems.length) e && l && !this.state.editing.scope && !t(this.suggestedListItems[0].value, e) && this.suggestedListItems.unshift({ value: e });
                                else {
                            ...
                            onClick(t) {
                                if (0 == t.button && t.target != this.DOM.dropdown && t.target != this.DOM.dropdown.content) {
                                    ...
                                    (this.state.actions.selectOption = !0),
                                        ...
                                        this.settings.hooks
                                            .suggestionClick(t, { tagify: this, suggestionElm: e })
                                            .then(() => {
                    ...
                    selectOption(t) {
                        ...
                        if ((this.trigger("dropdown:select", { data: n, elm: t }), a && n)) {
                            if (
                                (this.state.editing ? this.onEditTagDone(null, o({ __isValid: !0 }, n)) : this["mix" == this.settings.mode ? "addMixTags" : "addTags"]([n], i),
                                setTimeout(() => {
                        ...
                        for (l = h.caseSensitive ? "" + t : ("" + t).toLowerCase(); m < c.length; m++) {
                            ...
                            if (
                                (h.fuzzySearch && !e.exact
                                    ? ((a = t.reduce((t, e) => t + " " + (i[e] || ""), "").toLowerCase()), h.accentedSearch && ((a = r(a)), (l = r(l))), (s = v(a, l)))
                                    : (s = t.some((t) => {
                                          var s = "" + (i[t] || "");
                ...
                h = {
                    ...
                    hooks: { beforeRemoveTag: () => Promise.resolve(), suggestionClick: () => Promise.resolve() },
                },
                g = {
                    wrapper: (t, e) =>
                        `<tags class="${e.classNames.namespace} ${e.mode ? "" + e.classNames[e.mode + "Mode"] : ""} ${t.className}"\n                    ${e.readonly ? "readonly" : ""}\n                    ${
                            e.required ? "required" : ""
                        }\n                    tabIndex="-1">\n            <span ${e.readonly && "mix" == e.mode ? "" : "contenteditable"} data-placeholder="${e.placeholder || "&#8203;"}" aria-placeholder="${
                            e.placeholder || ""
                ...
                c = {
                    ...
                    callbacks: {
                            ...
                            if (!o && !r)
                                if (((this.state.hasFocus = "focus" == s && +new Date()), this.toggleFocusClass(this.state.hasFocus), "mix" != i.mode)) {
                                    ...
                                    "blur" == s &&
                                        (this.trigger("blur", n),
                                        this.loading(!1),
                                        ("select" == this.settings.mode ? !this.value.length || this.value[0].value != e : e && !this.state.actions.selectOption && i.addTagOnBlur) && this.addTags(e, !0)),
                                        this.DOM.input.removeAttribute("style"),
                                        this.dropdown.hide.call(this);
                                } else
                                    "focus" == s ? this.trigger("focus", n) : "blur" == t.type && (this.trigger("blur", n), this.loading(!1), this.dropdown.hide.call(this), (this.state.dropdown.visible = void 0), this.setStateSelection());
                        },
                        onKeydown(t) {
                            ...
                            if ((this.trigger("keydown", { originalEvent: this.cloneEvent(t) }), "mix" == this.settings.mode)) {
                                switch (t.key) {
                                    ...
                                    case "Backspace":
                                        ...
                                        if (
                                            ((r || d) && 1 == o.anchorNode.nodeType ? (a = 0 == o.anchorOffset ? (r ? g[0] : null) : g[o.anchorOffset - 1]) : r ? (a = o.anchorNode.nextElementSibling) : d && (a = d),
                                            3 == o.anchorNode.nodeType && !o.anchorNode.nodeValue && o.anchorNode.previousElementSibling && t.preventDefault(),
                                            (d || r) && !this.settings.backspace)
                                        )
                                        ...
                                        this.isFirefox && 1 == o.anchorNode.nodeType && 0 != o.anchorOffset && (this.removeTags(), this.placeCaretAfterNode(this.setRangeAtStartEnd())),
                                            setTimeout(() => {
                                                ...
                                                if (
                                                    ...
                                                    (this.removeTags(s), this.fixFirefoxLastTagNoCaret(), 2 == this.DOM.input.children.length && "BR" == this.DOM.input.children[1].tagName)
                                                )
                        ...
                        onMixTagsInput(t) {
                            ...
                            if (
                                ("deleteContentBackward" == t.inputType && l() && this.events.callbacks.onKeydown.call(this, { target: t.target, key: "Backspace" }),
                            ...
                            if (window.getSelection && (r = window.getSelection()).rangeCount > 0 && 3 == r.anchorNode.nodeType) {
                                if (
                                    ...
                                    try {
                                        (d = (d = this.state.flaggedTags[this.state.tag.baseOffset]).prefix == this.state.tag.prefix && d.value[0] == this.state.tag.value[0]),
                            ...
                            setTimeout(() => {
                                this.update({ withoutChangeEvent: !0 }),
                                    this.trigger("input", o({}, this.state.tag, { textContent: this.DOM.input.textContent })),
                        ...
                        onEditTagInput(t, e) {
                            ...
                            r || !0 !== t.originalIsValid || (l = !0),
                                i.classList.toggle(this.settings.classNames.tagInvalid, !0 !== l),
                                (a.__isValid = l),
                                (i.title = !0 === l ? a.title || a.value : l),
                                n.length >= this.settings.dropdown.enabled && (this.state.editing && (this.state.editing.value = n), this.dropdown.show.call(this, n)),
                                this.trigger("edit:input", { tag: i, index: s, data: o({}, this.value[s], { newValue: n }), originalEvent: this.cloneEvent(e) });
                        },
                        onEditTagFocus(t) {
                        ...
                        onEditTagBlur(t) {
                            if ((this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t))) {
                                ...
                                if (a)
                                    if (r) {
                                        if (((e = this.getWhitelistItem(a) || o({}, n, { [i.tagTextProp]: a, value: a })), i.transformTag.call(this, e, n), !0 !== (l = this.validateTag({ [i.tagTextProp]: e[i.tagTextProp] })))) {
                ...
                (p.prototype = {
                    ...
                    applySettings(t, e) {
                        ...
                        if (
                            ...
                            "autoComplete" in e && !n(e.autoComplete) && ((i.autoComplete = h.autoComplete), (i.autoComplete.enabled = e.autoComplete)),
                    ...
                    build(t) {
                        ...
                        this.settings.mixMode.integrated
                            ...
                            : ((e.originalInput = t), (e.scope = this.parseTemplate("wrapper", [t, this.settings])), (e.input = e.scope.querySelector(this.settings.classNames.inputSelector)), t.parentNode.insertBefore(e.scope, t)),
                        ...
                        if (a) {
                            if (!(r instanceof Object && "editable" in r) || r.editable)
                                return (
                                    ...
                                    this.tagData(t, { __originalData: o({}, r), __originalHTML: t.innerHTML }),
                                    ...
                                    a.addEventListener("keydown", (e) => l.onEditTagkeydown.call(this, e, t)),
                                    a.focus(),
                                    this.setRangeAtStartEnd(!1, a),
                                    e.skipValidation || (h = this.editTagToggleValidity(t, r.value)),
                                    (a.originalIsValid = h),
                                    this.trigger("edit:start", { tag: t, index: n, data: r, isValid: h }),
                                    this
                                );
                    ...
                    getWhitelistItem(e, i, s) {
                        ...
                        return (
                            (s = s || n.whitelist).some((s) => {
                                ...
                                if (t(o, e, n.dropdown.caseSensitive, n.trim)) return (a = "string" == typeof s ? { value: s } : s), !0;
                            }),
                            a || "value" != i || "value" == n.tagTextProp || (a = this.getWhitelistItem(e, n.tagTextProp, s)),
                            a
                        );
                    },
                    validateTag(t) {
                                    ...
                                    t.forEach((t) => {
                                        ...
                                        this.appendTag(e),
                                            t.__isValid && !0 === t.__isValid
                                                ? (this.value.push(t), this.update(), this.trigger("add", { tag: e, index: this.value.length - 1, data: t }))
                    ...
                    removeTags(t, e, i) {
                        ...
                        (t = t && t instanceof HTMLElement ? [t] : t instanceof Array ? t : t ? [t] : [this.getLastTag()]),
                            (s = t.reduce((t, e) => (e && "string" == typeof e && (e = this.getTagElmByValue(e)), e && t.push({ node: e, idx: this.getTagIdx(this.tagData(e)), data: this.tagData(e, { __removed: !0 }) }), t), [])),
                    ...
                    removeAllTags(t) {
                        var e = t || {};
                        (this.value = []),
                            "mix" == this.settings.mode ? (this.DOM.input.innerHTML = "") : Array.prototype.slice.call(this.getTagElms()).forEach((t) => t.parentNode.removeChild(t)),
                            this.dropdown.position.call(this),
                            "select" == this.settings.mode && this.input.set.call(this),
                            this.update({ withoutChangeEvent: e });
                    },
                    postUpdate() {
